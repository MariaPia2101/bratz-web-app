...
// Rectangle 1/2/3 nel container_spine della magazines_page (solo per il proprio
// magazine stampato). Ogni oggetto vive in un piccolo viewer three.js autonomo
// (canvas dedicato), con auto-fit e rotazione lenta continua.
// Stesso stack di scene.js (three da CDN + Draco). Se il 3D non è disponibile il
// riquadro resta semplicemente vuoto: nessun errore bloccante.
...
// Centra il modello nell'origine e adatta la distanza della camera.
...
function setupViewer(canvas, url) {
    ...
    let w = parent.clientWidth || 160;
    let h = parent.clientHeight || 160;
